    ...
    <div className="Instructions-container">
      ...
      <div className="Instructions-content">
        <section className="content-section">
          ...
          <div className="section-body">
            <p>
              ...
              any email sales from individual senders. To address this demand, we created DormDeals
              to centralize all the sales and deals around MIT, along with compelling features such
              as rating and review system, filtering sales, streamlined communication between buyers
        ...
        <section className="content-section">
          ...
          <div className="section-body">
            <p>
              When you log in, you will end up in the home page. The home page is the main part of
              the website and is where you can find all sorts of sales and deals around the MIT
              campus! Here, feel free to browse the numerous items currently being sold and add
              appropriate filters on the left-hand side to better fit your needs. Applying filters
              will automatically update the feed so that you can easily see what available items
              there are that fit your criteria. If you see an item you like, click on the card,
              which will take you to a new page with more details on the item. The home page is
              accessible through clicking the "DormDeals" icon on the left side of the navigation
              bar.
            </p>
        ...
        <section className="content-section">
          ...
          <div className="section-body">
            ...
            <p>
              ...
              any time by clicking the shopping cart icon in the navigation bar.
            </p>
            <div className="video-container">
              <div className="video-placeholder">
                <span>
        ...
        <section className="content-section">
          ...
          <div className="section-body">
            <p>
              See something you want to buy? Select all the items you want to checkout and by
              clicking the "Proceed to Checkout" button, it will redirect you to the purchase page,
              where you can confirm your orders. It is now up to you to contact the seller about
              your purchase and agree on a place and time to exchange. You have access to their
              emails and phone numbers after clicking on their profile. After confirming your
              purchase, you will be taken to your "My Purchases" page, where you can track the
              status of all your sales.
            </p>
            <div className="video-container">
              <div className="video-placeholder">
                <span>
        ...
        <section className="content-section">
          ...
          <div className="section-body">
            <p>
              ...
              Here, you are able to edit your own profile to include a description and email so
              others know how to contact you if they have any questions. Clicking the email will
              open a new window to send an email with the user as the recipient. You can customize
              your picture as well to give your profile more personality! Also included in the
              profile page are all the items that person is selling, making it easier for you to
            ...
            <p>
              ...
              option to leave a review and rating for the seller. To do that, go to "My Purchases"
              by clicking the shopping bag icon in the navigation bar. There, you will find a list
