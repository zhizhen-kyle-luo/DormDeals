    ...
    <div className="purchase-container">
      <div className="purchase-content">
        ...
        <div className="transaction-note">
          Note: After confirming your purchase, the item will be marked as "Under Transaction". The
          seller will mark it as "Sold" after the in-person exchange is completed.
        </div>
