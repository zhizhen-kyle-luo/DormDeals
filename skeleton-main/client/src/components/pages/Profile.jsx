...
const Profile = () => {
  ...
  const backgroundStyle = {
    backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(${userinformation?.backgroundImage || backgroundimg})`,
  };
    ...
    <div className="Profile-container">
      ...
      <div className="Profile-content">
          ...
          <div className="Profile-details">
            ...
            <Link to={`/UserReviews/${userId}`} className="Profile-detail">
              ...
              {userinformation?.rating ? 
                `${Number(userinformation.rating[0]).toFixed(1)} (${userinformation.rating[1]} reviews)` 
                : "No reviews yet"}
            </Link>
          </div>
        </div>
            ...
            <div className="Profile-editForm">
              ...
              <div className="Profile-formGroup">
                ...
                {newPicture.picture[0] && newPicture.picture[0] !== defaultpfpimg && (
                  <div className="Profile-avatarContainer" style={{ margin: '1rem auto', width: '150px', height: '150px' }}>
                    <img
                      src={newPicture.picture[0]}
                      alt="Preview"
                      className="Profile-avatar"
                    />
                  </div>
        ...
        <div className="Profile-section">
          ...
          <p className="Profile-aboutText">{userinformation?.description || "No description provided."}</p>
        </div>
